...
const Header1 = () => {
  return (
    <nav
      id="nav"
      className=" flex  top-0  w-full p-6 bg-white 2xl:h-32 lg:h-24 h-[85px]"
    >
      <div className="flex flex-row justify-between w-full pl-2 lg:pl-20 ">
        ...
        <div className="flex flex-row  lg:pr-5 gap-3 justify-center items-center">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
          ...
          <div className="hidden lg:flex flex-row justify-center items-center gap-5">
            <SellerSigninModal/>
            <button className="w-[216px]  h-9 2xl:h-[48px] flex items-center justify-center text-white hover:text-black border border-transparent hover:border-black   bg-[#ff0000] hover:bg-transparent rounded-lg active:border-[#ff0000] active:text-[#ff0000]">
              Contact Us
            </button>
          </div>
        </div>
